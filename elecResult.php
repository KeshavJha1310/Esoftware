...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']!=true){
  ...
  exit;
} else if (isset($_SESSION['result_E']) && isset($_SESSION['notification'])) {
// Check if the session variables are se (isset($_SESSION['result']) && isset($_SESSION['notification'])) {
    $result_C = $_SESSION['result_E'];
    $fix_C = $_SESSION['fix_E'];
...
echo '<button class="next" id="next" ><a style="text-decoration: none; border: 2px solid; border-radius:5px;color:black;"href="./thank.php">Next</a></button>';
