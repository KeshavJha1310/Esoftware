...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    $con1 = mysqli_connect('127.0.0.1:3306', 'root', '','e_software_new');
$date = $_POST["date"];
...
$_SESSION['notification'] = ($result_E > $fix_E) ? "Save Electricity" : "Going Green";   
...
echo '<button class="next1" id="next" ><a href="./elecResult.php">Results</a></button>';  
       exit;
         }
         ?>
