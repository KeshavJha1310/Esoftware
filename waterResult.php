...
if(!isset($_SESSION['loggedin']) || $_SESSION['loggedin']!=true){
  ...
  exit;
} else if (isset($_SESSION['result']) && isset($_SESSION['notification'])) {
...
echo "<p1 style='font-size: 36px; z-index: inherit ;position:relative;top: 50px;left: 200px;font-family: TimesNewRoman; color: " . (($result > $fix) ? "red" : "green") . ";'>The Total Amount of Water You Used today is $result litre/s</p1>";
echo "</div>"; // Close centering container
echo '<button class="next" id="next" ><a style="text-decoration: none; border: 2px solid; border-radius:5px;color:black;"href="./fuel.php">Next</a></button>';
